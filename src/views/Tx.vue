...
<div id="Tx">
  ...
  <div class="view">
    ...
    <div v-if="txs.length > 1">     
      <h2>
        <img src="https://www.contobit.com/imagens/txbtc.png" width="43.2px" height="30.4px">
      ...
      <div v-if="vertxs">
          ...
          <tbody>
            <tr v-for="(item, index) in txs" :key="index">
              ...
              <td  :data-th="tit_table_tx_encurso.mat[svl()][1].vl" v-if="item.CADENARED === '₿'">
                <font color="black" size=5><b><i> 🔗</i></b></font>
              </td>
              <td  :data-th="tit_table_tx_encurso.mat[svl()][1].vl" v-if="item.CADENARED === '⚡'">
                <font color="Darkorange" size=6> ⚡</font>
              </td>
              ...
              <td  :data-th="tit_table_tx_encurso.mat[svl()][7].vl" v-if="nomuser === item.COMPRADOR">
                <font color="mediumseagreen">
                  <img align="bottom" src="https://www.contobit.com/imagens/carrito.png" width="25px"
                    height="17.4px" />{{tit_table_tx_encurso_td.td_rol[svl()][0].vl}}
                </font>
              </td>
              <td  :data-th="tit_table_tx_encurso.mat[svl()][7].vl" v-if="nomuser === item.VENDEDOR">
                <font color="tomato">
                  <img align="bottom" src="https://www.contobit.com/imagens/manita.png" width="25px" height="17.4px" />{{tit_table_tx_encurso_td.td_rol[svl()][1].vl}}
                </font>
              </td>
        ...
        <!-- <span> selectedselTX... {{ this.selectedselTX }} </span> -->
      </div>
    </div>
    <!--  {{txs}} -->
    ...
    <div v-if="txs.length === 1">
        <!-- **** sigue etiqueta del título  para ₿ Cadena de bloques Bitcoin -->       
        <h2><img src="https://www.contobit.com/imagens/txbtc.png" width="43.2px" height="30.4px">
            <span id="tittransacs">{{tit_transac.mat[svl()][1].vl}}</span><span v-if="tx.CADENARED === '₿'"> 🔗</span><span v-if="tx.CADENARED === '⚡'"> ⚡</span> 
        </h2>
    </div>
    ...
    <div class="container" v-if="tx.VENDEDOR !== undefined">
            ...
            <div class="rotar1 col-2 my-1 mx-2">
              <popper v-if="tx.CADENARED === '₿'"
                  ...
                  <div class="popper" style="margin-top:20px;margin-left:-15px;">                         
                    ...
                    <b>{{tit_table_tx_encurso.mat[svl()][1].vl}}: <font color=White><i>🔗</i></font></b>
                     {{tit_transac.bitcoin[svl()][0].vl}} <br>
                    ...
                    <b>{{tit_transac.enunciats[svl()][3].vl}}:</b> {{this.oferta.LIMITEABAJO}}  BTC - 
                    {{this.oferta.LIMITEARRIBA}} BTC<br><br>                      
                  </div>               
              ...
              <popper v-if="tx.CADENARED === '⚡' "
                  ...
                  <div class="popper" style="margin-top:20px;margin-left:-15px;">                         
                    ...
                    <a :href="this.url +this.oferta.NOMBREUSUARIO" target="_blank">
                    <font color=red>{{this.oferta.NOMBREUSUARIO}} </font></a></i></b><br>
                    <b>{{tit_table_tx_encurso.mat[svl()][1].vl}}: <font color=Darkorange><i>⚡</i></font></b>
                     {{tit_transac.lightning[svl()][0].vl}} <br>
                    <b>{{cap1.mtx[svl()][0].vl}}: </b>{{this.oferta.FORMADEPAGO}} <br>
                    <b>{{tit_transac.enunciats[svl()][0].vl}}: </b>
                    {{this.oferta.GRUPOBANCO}} -<b><font color=yellow> {{this.oferta.NOMBANCO}} </font></b> <br> 
                    <b>{{tit_transac.enunciats[svl()][1].vl}} ₿ :</b> <b><font color=yellow>
            ...
            <div class="rotar1 col-5 my-1 mx-2">
              <popper 
                  ...
                  <div class="popper" style="margin-top:25px;" >                         
                    ...
                    {{this.tx.IMPORTECOMPRA}}  BTC </font></i></b><br>
          ...
          <div id="cap6">
            <div class="rotar1 col-15 my-1 mx-5">
               ...
               <popper v-if="tx.CADENARED === '⚡'"
                   trigger="clickToOpen"
                  :options= popoptionsl>
                  <div class="popper_caps" style="margin-top:40px;">                        
                    <br /><h4><b>{{tit_table_tx_encurso_td.td_momentum[svl()][5].vl}}</b>:</h4>
                    <b><font color=Darkorange>⚡</font> {{tit_transac.enunsln[svl()][4].vl}}:<br /><i>
                    <a href="#open-modal9"><font color=DodgerBlue>{{this.lnpayreqentrega_redu}}...</font></a>
                    <span id="open-modal9" class="modal-window" style="margin-left:-160px;top:140px;">
                      <div>
                        <a href="#" :title="Cerrar.mtx[svl()][0].vl" class="modal-close">❌</a>
                        <small><font color=Black>Qr-code {{tit_transac.enunsln[svl()][4].vl}} :</font></small>
                        <qrcode-vue :value="this.tx.LNPAYMENTREQ_ENTREGA" :size="200" level="H"></qrcode-vue>
                      </div>
                    </span>
                    </i></b><br>
                    <b>⚡ {{tit_transac.enunsln[svl()][5].vl}} : <i><font color=yellow>
                    <a href="#open-modal10"><font color=DodgerBlue>{{this.tx.LNINVOICEID_ENTREGA}}</font></a>
                    <span id="open-modal10" class="modal-window" style="margin-left:-395px;top:140px;">
                      <div>
                        <a href="#" :title="Cerrar.mtx[svl()][0].vl" class="modal-close">❌</a>
                        <small><font color=Black>Qr-code {{tit_transac.enunsln[svl()][5].vl}} :</font></small>
                        <qrcode-vue :value="this.tx.LNINVOICEID_ENTREGA" :size="200" level="H"></qrcode-vue>
                      </div>
                    </span>
                    </font></i></b><br>
                    <b>⚡ {{tit_transac.enunsln[svl()][6].vl}} : <i><font color=yellow>
                    <a href="#open-modal11"><font color=DodgerBlue>{{this.tx.LNPPAYMENTREQ_ENTREGA}}</font></a>
                    <span id="open-modal11" class="modal-window" style="margin-left:-395px;top:140px;">
                      <div>
                        <a href="#" :title="Cerrar.mtx[svl()][0].vl" class="modal-close">❌</a>
                        <small><font color=Black>Qr-code {{tit_transac.enunsln[svl()][6].vl}} :</font></small>
                        <qrcode-vue :value="this.tx.LNPPAYMENTREQ_ENTREGA" :size="200" level="H"></qrcode-vue>
                      </div>
                    </span>
                    </font></i></b><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                  </div>               
                  <a href="#" slot="reference" class="btn btn">
                      <h6><small>{{caps.mtx[svl()][5].vl}}</small></h6>
                  </a>
        ...
        <div class="cajatl">          
           ...
           <popper v-if="tx.CADENARED === '₿'"
             ...
             <div class="popper_tl"><!-- contenido del popper tip aqui -->                                       
              ...
              <b>{{tit_table_tx_encurso.mat[svl()][1].vl}}: <font color=White><i>🔗</i></font></b> {{tit_transac.bitcoin[svl()][0].vl}} <br>
              ...
              <a href="#" slot="reference" v-if="tx.CADENARED === '₿'" class="btn btn">
                      ...
                      <div class="row">
                        <div v-if="tx.TIMELINE === '1.Oferta'" id="car1">
                          <img align="bottom" src="https://www.contobit.com/imagens/manita.png" width="30px" height="21px" />
                        </div>
                        <div v-if="tx.TIMELINE === ''" id="car1">
                          <img align="bottom" src="https://www.contobit.com/imagens/carrito.png" width="30px" height="21px" />
                        </div>
                        ...
                        <div v-if="tx.TIMELINE === 'Arbitraje'" id="car4">
                          <h5><img src="https://www.contobit.com/imagens/balance_btc.png" width="25px" height="17.4px"></h5>
                        </div>
         ...
         <!-- **** sigue etiqueta del título todas las estaciones para ⚡ lightning network -->
           ...
           <popper v-if="tx.CADENARED === '⚡' "
              ...
              <br /><h4><b>{{tit_table_tx_encurso_td.td_momentum[svl()][0].vl}}</b> :</h4>
              <b>{{tit_table_tx_encurso_td.td_rol[svl()][1].vl}}: <i>
              <a :href="this.url +this.oferta.NOMBREUSUARIO" 
              target="_blank">
              <font color=RED>
              {{this.oferta.NOMBREUSUARIO}} </font></a>
              </i></b><br>
              <b>{{tit_table_tx_encurso.mat[svl()][1].vl}}:  <font color=Darkorange>⚡</font></b> {{tit_transac.lightning[svl()][0].vl}} <br>
              <b>{{tit_transac.enunciats[svl()][0].vl}}:<br></b>
              {{this.oferta.GRUPOBANCO}} 
               - <i><b><font color=yellow>
              {{this.oferta.NOMBANCO}} 
              ...
              <h4><b>{{tit_table_tx_encurso_td.td_momentum[svl()][3].vl}}</b> :</h4>
              <b>{{tit_transac.enunciats[svl()][11].vl}}:<i><font color=yellow> {{this.tx.PAGO_COMPRADOR}} 
              </font></i></b><br><br>
              <h4><b>{{tit_table_tx_encurso_td.td_momentum[svl()][4].vl}}</b> :</h4>
              <b>{{tit_transac.enunciats[svl()][12].vl}}:<i><font color=yellow> {{this.tx.COBRO_VENDEDOR}} </font></i></b><br><br>
              <h4><b>{{tit_table_tx_encurso_td.td_momentum[svl()][5].vl}}</b> :</h4>
              <b><font color=Darkorange>⚡</font> {{tit_transac.enunsln[svl()][4].vl}}: <i>
              <a href="#open-modal3"><font color=DodgerBlue>{{this.lnpayreqentrega_redu}}...</font></a>
              <span id="open-modal3" class="modal-window" style="margin-left:-125px;top:155px;">
                <div>
                  <font color=DimGray><small>Qr-code </small></font><a href="#" :title="Cerrar.mtx[svl()][0].vl" class="modal-close">❌</a><br>
                  <small><font color=Black>{{tit_transac.enunsln[svl()][4].vl}} :</font></small>
                  <qrcode-vue :value="this.tx.LNPAYMENTREQ_ENTREGA" :size="200" level="H"></qrcode-vue>
                </div>
              </span>
              </i></b><br>
              <b><font color=Darkorange>⚡</font> {{tit_transac.enunsln[svl()][5].vl}}: <i>
              <a href="#open-modal4"><font color=DodgerBlue>{{this.tx.LNINVOICEID_ENTREGA}}</font></a>
              <span id="open-modal4" class="modal-window" style="top:150px;">
                <div>
                  <font color=DimGray><small>Qr-code </small></font><a href="#" :title="Cerrar.mtx[svl()][0].vl" class="modal-close">❌</a><br>
                  <small><font color=Black>{{tit_transac.enunsln[svl()][5].vl}} :</font></small>
                  <qrcode-vue :value="this.tx.LNINVOICEID_ENTREGA" :size="200" level="H"></qrcode-vue>
                </div>
              </span>                
              </i></b><br>
              <b><font color=Darkorange>⚡</font> {{tit_transac.enunsln[svl()][6].vl}}: <i>
              <a href="#open-modal5"><font color=DodgerBlue>{{this.tx.LNPPAYMENTREQ_ENTREGA}}</font></a>
              <span id="open-modal5" class="modal-window" style="top:155px;">
                <div>
                  <font color=DimGray><small>Qr-code </small></font><a href="#" :title="Cerrar.mtx[svl()][0].vl" class="modal-close">❌</a><br>
                  <small><font color=Black>{{tit_transac.enunsln[svl()][6].vl}} :</font></small>
                  <qrcode-vue :value="this.tx.LNPPAYMENTREQ_ENTREGA" :size="200" level="H"></qrcode-vue>
                </div>
              </span>              
              </i></b><br>
              ...
              <a href="#" slot="reference" v-if="tx.CADENARED === '⚡'" class="btn btn">
                      ...
                      <img
                      class="img_ln" style="margin-left:-25px;"
                      src="https://www.contobit.com/imagens/timeline.png" />
                      <div class="row">
                        <div v-if="tx.TIMELINE === '1.Oferta'" id="car1">
                          <img align="bottom" src="https://www.contobit.com/imagens/manita.png" width="30px" height="21px" />
      ...
      <span id="interc3" >        
        ...
        <span v-else>
          <font color="Darkorange" size=6><b><small> ⚡</small></b></font>
        </span>
          {{this.tx.IMPORTECOMPRA }} BTC
        </span>
                ...
                <div class="container" :class="{'sign-up-active' : signUp}">
                  ...
                  <div v-if="tx.TIMELINE === 'Arbitraje'">
                    <form @submit.prevent="updateCobro()" class="sign-in" action="#">
                      <h3>
                        <font color="grey">
                          <b> <img src="https://www.contobit.com/imagens/balance_btc.png" width="25px" height="17.4px"> {{Aportes.mtx[svl()][1].vl}}</b>
                        </font>
                      </h3>
                      <br />
                      ...
                      <b-button variant="outline-primary btn-success btn-block" id="signUp" type="submit">
                        ...
                        <img /> <img src="https://www.contobit.com/imagens/balance_btc.png" width="25px" height="17.4px"> {{Res_arbitro.mtx[svl()][4].vl}}
                      </b-button>
                    </form>
                  </div>
                  <div v-if="(tx.COBRO_VENDEDOR === '⚖️✅' | tx.COBRO_VENDEDOR === '⚡⚖️🔐✅' | tx.COBRO_VENDEDOR === '⚡⚖️✅' ) & (tx.TIMELINE === '5.Cobro' | tx.TIMELINE === '6.Entrega')">
                    <form @submit.prevent="pagar_LN_byarbitraje()" class="sign-in" action="#">
                      <h3>
                        <font color="grey">
                          <b> <img src="https://www.contobit.com/imagens/balance_btc.png" width="25px" height="17.4px"> {{Aportes.mtx[svl()][1].vl}}</b>
                        </font>
                      ...
                      🔐 BITCOIN ON CHAIN TX ID ⚖️✅... 
                      <textarea class="form-control" rows="1"
                        v-model="tx.IDTX_ENTREGA"
                        readonly></textarea><br />                       
                      <br />
                      <label> Buyer Payment Request:</label>
                      <textarea class="form-control" rows="3"
                        :placeholder="Res_arbitro.mtx[svl()][2].vl" v-model="tx.LNPAYMENTREQ_ENTREGA"
                        readonly></textarea><br />

                      *** Antes de pulsar esperar y verificar si el Vendedor coopera en pagar o no ***  
...
<script>
  ...
  export default {
    ...
    data() {
      ...
      tit_transac: {
       mat: [
          [{ vl: 'Arbitraje compra-venta' },{ vl: 'Transacción compra-venta' }],
          [{ vl: 'Purchase-sale Arbitration' },{ vl: 'Purchase-sale transaction' }],
          [{ vl: 'Arbitratge compravenda' },{ vl: 'Transacció compra-venda' }],
          [{ vl: 'Arbitragem compra e venda' },{ vl: 'Transação de compra e venda' }],                                               
            ],
       bitcoin: [
       ...
       enunciats: [
          [{ vl: 'Medio de pago' },{ vl: 'Precio' },{ vl: 'Moneda de pago' },{ vl: 'Mínimo - Máximo' },{ vl: 'Compra' },{ vl: ' por importe de ' },{ vl: 'Prueba solvencia de compra aceptada' },{ vl: '🔐 Multigarantía Multifirma' },{ vl: 'Arbitraje' },{ vl: 'Respaldo Entrega Firmada(2/2), Tx' },{ vl: 'Cadena de bloques Bitcoin, 6 confirmaciones, garantia' },{ vl: 'Notificación del comprador' },{ vl: 'Ratificación del vendedor' },{ vl: 'Destino Comprador' },{ vl: 'Entrega de Bitcoins, Identificador Tx' }, ],
          [{ vl: 'Payment method' },{ vl: 'Price' },{ vl: 'Payment currency' },{ vl: 'Min MAX' },{ vl: 'Purchase' },{ vl: 'for the amount of' },{ vl: 'Proof of purchase solvency accepted' },{ vl: '🔐 Multi-signature Multi-guarantee' },{ vl: 'Arbitration' },{ vl: 'Support Delivery Signed(2/2), Tx' },{ vl: 'Bitcoin Blockchain, 6 confirmations, guarantee' },{ vl: 'Buyer`s notification' },{ vl: 'Seller`s ratification' },{ vl: 'Buyer Destination' },{ vl: 'Bitcoins Delivery, Tx Identifier' },],
          [{ vl: 'Mitjà de pagament' },{ vl: 'Preu' },{ vl: 'Moneda de pagament' },{ vl: 'Mínim - Màxim' },{ vl: 'Compra' },{ vl: 'per import de' },{ vl: 'Prova solvència de compra acceptada' },{ vl: '🔐 Multigarantia Multisignatura' },{ vl: 'Arbitratge' },{ vl: 'Respatller Lliurament Signat(2/2), Tx' },{ vl: 'Cadena de blocs  bitcoin, 6 confirmacions, garantia' },{ vl: 'Notificació del comprador' },{ vl: 'Ratificació del venedor' },{ vl: 'Destí Comprador' },{ vl: 'Lliurament de Bitcoins, Identificador Tx' },],
          [{ vl: 'Meio de pagamento' },{ vl: 'Preço' },{ vl: 'Moeda de pagamento' },{ vl: 'Mínimo - Máximo' },{ vl: 'Compra' },{ vl: 'pela quantidade de' },{ vl: 'Comprovante de solvência de compra aceita' },{ vl: '🔐 Multi-assinatura Multi-garantia' },{ vl: 'Arbitragem' },{ vl: 'Entrega de suporte assinada(2/2), Tx' },{ vl: 'Bitcoin blockchain, 6 confirmações, garantia' },{ vl: 'Notificação do comprador' },{ vl: 'Ratificação do vendedor' },{ vl: 'Destino do comprador' },{ vl: 'Entrega de Bitcoins, Identificador Tx' },],                                         
            ],                    
       enunsln: [
          [{ vl: 'Solicitud de Pago(liberación)' },{ vl: 'Garantía en Multifirma' },{ vl: 'Tx de Respaldo Firmada 2/2' },{ vl: 'Garantizado al Arbitraje' },{ vl: 'Solicitud de Pago(Entrega)' },{ vl: 'Factura ID(Entrega)' },{ vl: 'Prueba de Pago(Entrega)' },{ vl: 'Tx ID de Garantía' }],

          [{ vl: 'Payment Request (release)' },{ vl: 'Warranty in Multisignature' },{ vl: 'Backup Tx Signed 2/2' },{ vl: 'Release in arbitration, received' },{ vl: 'Payment Request (Delivery)' },{ vl: 'Invoice ID (Delivery)' },{ vl: 'Proof of Payment (Delivery)' },{ vl: 'Tx Warranty ID' }],

          [{ vl: 'Sol.licitud de Pagament(alliberament)' },{ vl: 'Garantia a Multifirma' },{ vl: 'Tx de Respatller Signada 2/2' },{ vl: 'Alliberament en arbitraje, rebut' },{ vl: 'Sol.licitud de Pagament(Lliurament)' },{ vl: 'Factura ID(Lliurament)' },{ vl: 'Prova de Pagament(Lliurament)' },{ vl: 'Tx ID de Garantia' }],

          [{ vl: 'Pedido de pagamento (liberação)' },{ vl: 'Garantia em Multisignature' },{ vl: 'Backup Tx assinado 2/2' },{ vl: 'Liberação em arbitragem, recebida' },{ vl: 'Pedido de pagamento (Entrega)' },{ vl: 'ID da fatura (entrega)' },{ vl: 'Comprovante de pagamento (entrega)' },{ vl: 'Tx ID de Garantia' }],,                                         
            ],           
      },           
      help_tline: {
       mtx: [
    ...
    // empiezan necesarias traducciones de las functions
     ...
     f_checkPp_lib_Ln: {
         txts: [
          [{ vl: ' Entrega por el Arbitraje.'},{ vl: 'Verificada sin éxito ⚡ Prueba de Pago(liberación) por importe de  '},{ vl: ' BTC, por favor revise...'},{ vl: 'Por favor previamente introduzca o pegue en la casilla, la ⚡ Prueba de Pago(preimage).'}],
          [{ vl: 'Delivery by the Arbitration.'},{ vl: 'Verified unsuccessfully ⚡ Proof of Payment (release) for the amount of   '},{ vl: ' BTC, please review...'},{ vl: 'Please previously enter or paste in the box, the ⚡ Proof of Payment (preimage).'}],
          [{ vl: 'Entrega per l`Arbitratge.'},{ vl: 'Verificada sin éxito ⚡ Prueba de Pago(liberación) por importe de  '},{ vl: ' BTC, por favor revise...'},{ vl: 'Siusplau prèviament introdueixi o engantxi a la casella, la ⚡ Prova de Pagament(preimage).'}],
          [{ vl: 'Entrega pelo Arbitraje.'},{ vl: 'Verificada sin éxito ⚡ Prueba de Pago(liberación) por importe de  '},{ vl: ' BTC, siusplau revisi-ho...'},{ vl: 'Por favor introduza previamente ou pegue na casilla, la ⚡ Prueba de Pago(preimage).'}],                                         
            ],                       
      },          
     f_leertxs: {
         txts: [
    ...
    methods: {
      ...
      rchild(){
        ...
        if (this.nomuser === this.tx.COMPRADOR & this.$route.fullPath !== '/Tx/Txc') router.push({ path: '/Tx/Txc' });
        if (this.nomuser === this.tx.VENDEDOR & this.$route.fullPath !== '/Tx/Txv') router.push({ path: '/Tx/Txv' });
        this.verchild = true;
        }
      },
      svl() {
      ...
      ahora() {
        // moment.locale("es");
        let fecha = Date.now();
        // mejor encriptar valor fecha con bycript
        return fecha;
      },
      ...
      pagar_LN_byarbitraje() {
        ...
        if (this.tx.LNPAYMENTREQ_ENTREGA !== "⏳" & this.tx.CADENARED === "⚡") {
          let Ln_paymreq_entreg = this.tx.LNPAYMENTREQ_ENTREGA;
          console.log("Ln_paymreq_entreg...."+Ln_paymreq_entreg);
            ...
            this.axios // arbitro paga pay req para confirmar
              ...
              .then((res) => {
                  ...
                  if (res.data.payment_preimage.data) {
             ...
             if ( res.data.payment_error !== "") { // no se produjo pago LN

               if ( res.data.payment_error === 'invoice is already paid') {
                Swal.fire( // si el invoice es de la entrega, correcto el arbitro ya pagó
                  res.data.payment_error,
                  "",
                  "success"
                );
               } else { // hubo algun error en el pago no-route u otro y no se ejecutó
                Swal.fire( 
                  res.data.payment_error,
                  "payment not executed, notify to buyer and retry later...",
                  "error"
                );
               }                                                  

             } else { //  osea pagada por arbitraje
                Swal.fire(
                  "true_preimage...(proof of payment):",
                  true_preimage,
                  "success"
                ); 
        ...
        } else { // el comprador todavia no emitió la request payment
          console.log("Ln_paymreq_entreg...."+this.tx.LNPAYMENTREQ_ENTREGA);
        }          
      ...
      // reinicializamos variables de chat
        ...
        this.participants = [
          ...
          },
          {
            ...
            imageUrl: "https://www.contobit.com/imagens/balance_btc.png",         
          },
          {
            id: this.tx.VENDEDOR,
            name: this.tx.VENDEDOR,
            imageUrl: "https://www.contobit.com/imagens/manita.png",
          },
          {
            id: this.tx.COMPRADOR,
            name: this.tx.COMPRADOR,
            imageUrl: "https://www.contobit.com/imagens/carrito.png",
          }          
